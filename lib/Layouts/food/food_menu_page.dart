...
//      ),
      body: SafeArea(
          child: Container(
//            decoration: BoxDecoration(
//              image: DecorationImage(image: AssetImage("res/background-01.jpg"), )
//            ),
            child: ListView(
              children: <Widget>[
                FirstHalf(),
...
class CustomAppBar extends StatelessWidget {
  ...
  GestureDetector buildGestureDetector(
    ...
    return GestureDetector(
      ...
      child: Container(
        margin: EdgeInsets.only(right: 20),
        child: Text(length.toString(),textScaleFactor: 1.5,

        ),
        padding: EdgeInsets.all(15),
        decoration: BoxDecoration(
             color: Color(0xff90676f),borderRadius: BorderRadius.circular(50)),
      ),
    );
  }
}